...
def main():
    ...
    """
    left_data, right_data, original_centerline, original_kappa, opt_centerline, kappa_s = get_centerline("./tracks/spa left.kml", "./tracks/spa right.kml", optimize=True) 
    df = load_gg_data(velocity_values, 0)

    """
    Plotting our track and centerlines
    """
    # plot_optimal(left_data, right_data, opt_centerline, show_original=True, original_line=original_centerline)
    ...
    """
    Calling optimize to get an optimized lap time
    on a 2D-planar track
    """
